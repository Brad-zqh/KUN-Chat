(() => {
  const copy = {
    zh: {
      ...
      description: "KUN Chat：集成 RAG、语音识别和多角色编排的中英双语 AI 数字人平台。",
      brandTag: "AI 数字人对话平台", repository: "代码仓库",
      eyebrow: "RAG · 语音交互 · 多角色编排",
      heroTitle: "让 AI 角色拥有<br><span>有依据的表达</span>",
      heroLead: "KUN Chat 是一个可部署的 AI 数字人平台，结合经过审核的检索增强生成、中文语音识别、文本转语音和多模型路由，构建自然且可追溯的角色对话体验。",
      tryProduct: "体验在线版本 ↗", viewCode: "查看 GitHub 代码",
      metricPersonas: "独立角色", metricGrounded: "可溯源回答", metricVoice: "完整语音链路",
      ...
      flowReplyTitle: "多模型生成与语音回复", flowReplyBody: "DeepSeek / MiniMax · TTS 播放",
      capTitle: "工程能力", capLead: "从资料治理到公网部署，项目覆盖了完整的 AI 应用链路，而不仅是一个聊天界面。",
      capRagTitle: "双层 RAG", capRagBody: "将事实依据与表达风格分离检索，并对未审核材料采取默认拒绝策略。",
      capVoiceTitle: "端到端语音", capVoiceBody: "支持按住说话、本地 Whisper 识别、专名热词以及角色化 TTS 回复。",
    ...
    en: {
      ...
      description: "KUN Chat is a bilingual AI persona platform combining grounded RAG, speech recognition, and multi-persona orchestration.",
      brandTag: "AI Persona Conversation Platform", repository: "Repository",
      eyebrow: "RAG · Voice Interaction · Multi-persona Orchestration",
      heroTitle: "AI personas with<br><span>grounded voices</span>",
      heroLead: "KUN Chat is a deployable AI persona platform that combines reviewed retrieval-augmented generation, Chinese speech recognition, text-to-speech, and multi-model routing to deliver natural, traceable conversations.",
      tryProduct: "Try the live product ↗", viewCode: "View source on GitHub",
      metricPersonas: "Independent personas", metricGrounded: "Traceable answers", metricVoice: "Full voice pipeline",
      ...
      flowReplyTitle: "Model routing and voice reply", flowReplyBody: "DeepSeek / MiniMax · TTS playback",
      ...
      capVoiceTitle: "End-to-end voice", capVoiceBody: "Push-to-talk recording, local Whisper ASR, proper-name hotwords, and persona-specific TTS responses.",
