(() => {
  const copy = {
    zh: {
      ...
      roleCan: "老残", roleCanNote: "阅读与表达", roleQiu: "皓哥", roleQing: "爷爷", roleNai: "奶奶",
      roleYuxin: "邹大猩猩", roleYuxinNote: "独立 RAG", authorized: "授权数字人",
    ...
    en: {
      ...
      roleCan: "Laocan", roleCanNote: "Reading & expression", roleQiu: "Qiuhao", roleQing: "Grandpa", roleNai: "Grandma",
      roleYuxin: "Zou Gorilla", roleYuxinNote: "Independent RAG", authorized: "Authorized persona",
